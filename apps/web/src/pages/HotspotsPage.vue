...
const fields = computed<CrudField[]>(() => [
  ...
  {
    key: "section-personalizacao",
    label: "Personalizacao do portal",
    type: "section",
    full: true,
    help: "Customize logo, textos e cores do portal publico deste hotspot. Campos vazios usam o padrao CAS.",
  },
  {
    key: "portalLogoUrl",
    label: "URL da logo",
    ...
    help: "Use uma URL publica ou caminho servido pelo frontend, como /img/logo.png.",
  },
  {
    key: "portalTitulo",
