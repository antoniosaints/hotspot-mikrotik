...
const hotspotCreateSchema = z.object({
  ...
  portalLogoUrl: z.string().optional().nullable(),
  portalTitulo: z.string().optional().nullable(),
  portalSubtitulo: z.string().optional().nullable(),
  portalRodape: z.string().optional().nullable(),
  portalCorFundo: z.string().optional().nullable(),
  portalCorFundoFim: z.string().optional().nullable(),
  portalCorTexto: z.string().optional().nullable(),
